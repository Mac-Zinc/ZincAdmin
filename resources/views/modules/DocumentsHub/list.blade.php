       ...
       <div>            
            ...
            <div class="portlet-body">
                <div class="table-container">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable" id="documents_table">
                        <thead>                                
        ...
        jQuery(document).ready(function() {
            dataTableControler = initAjaxDatatablesCRMTable('documents_table','ListRowsAjax/Documents');
        });
        </script>