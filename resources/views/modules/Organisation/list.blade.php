   <style>
       ...
       .btn.btn-outline.blue {
        ...
        .btn.btn-outline.red {
             background: #e7505a none repeat scroll 0 0;
             border-color: #e7505a;
             color: #fff !important;
         }
        .tool-action {
   ...
   <div>
            ...
            <div class="portlet light portlet-fit portlet-datatable ">
                ...
                <div class="portlet-body">
                    <div class="table-container">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable" id="organisation_table">
                            <thead>                                
    ...
    jQuery(document).ready(function() {
        dataTableControler = initAjaxDatatablesCRMTable('organisation_table','ListRowsAjax/Organisation');
    });
    </script>